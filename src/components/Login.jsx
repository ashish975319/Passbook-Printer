...
import logoLight1 from "../assets/logolight1.png";
import { useNavigate } from "react-router-dom";
import API_URLS from "../constants/apiConfig"; // Import URLs
        ...
        <div className="mt-8 space-y-5">
          ...
          <div>
            <button
              type="button"
              onClick={handleSubmit}
              className="w-full inline-flex items-center justify-center rounded-md bg-purple-700 px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-black/80 focus:outline-none"
            >
              Get OTP <ArrowRight className="ml-2" size={16} />
            </button>
          </div>
